...
public class WaterApp extends JPanel{
    ...
    private static final String PREF_CURRENT_DATA = "WATER_CURRENT_DATA";
    private static final String PREF_PREVIOUS_DATA = "WATER_PREVIOUS_DATA";
    private static final String PREF_TARIFF = "WATER_TARIFF";
